      ...
      <div className="max-w-6xl mx-auto">
            ...
            return (
              <Card key={section.title} className="glass-card border-white/10 bg-black/20">
                ...
                <CardContent>
                  ...
                  <Link href={section.href} className="inline-flex items-center text-primary font-semibold hover:text-primary/80 transition-colors">
                    {section.cta}
        ...
        <div className="glass-card rounded-3xl border border-white/10 p-8 md:p-10 flex flex-col md:flex-row md:items-center md:justify-between gap-5">
          ...
          <div className="flex gap-3">
            <Link href="/auth/register?source=docs_final_cta&intent=trial&plan=pro">
