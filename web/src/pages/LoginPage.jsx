...
import { Mail, Lock, LogIn, AlertCircle, Sparkles, ArrowLeft } from 'lucide-react';
                ...
                <div className="glass-card rounded-2xl p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="btn-glow w-full flex items-center justify-center gap-2 py-4 text-white rounded-xl font-bold text-base disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {loading ? (
