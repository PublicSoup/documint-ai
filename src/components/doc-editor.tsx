...
export default function DocEditor({ fileId, fileName, fileLanguage, initialContent, isPublic: initialPublicState }: DocEditorProps) {
    ...
    const handleRegenerate = async () => {
        ...
        try {
            ...
            toast("Failed to regenerate documentation. Is LM Studio running?", "error");
        } finally {
    ...
    const handleRegenerateEntity = async (index: number) => {
        ...
        try {
            ...
            toast("Failed to regenerate. Is LM Studio running?", "error");
        } finally {
    ...
    const handleDownload = () => {
        ...
        md += `**Generated By:** DocuMint AI (Qwen 2.5 Coder)\n\n`;
        md += `## Summary\n\n${content.summary}\n\n`;
    ...
    const handleExportAdoc = () => {
        try {
            ...
            adoc += `*Generated By:* DocuMint AI (Qwen 2.5 Coder)\n\n`;
    ...
    const handleExportRST = () => {
        try {
            ...
            rst += `**Generated By:** DocuMint AI (Qwen 2.5 Coder)\n\n`;
...
<body>
    ...
    <div class="meta">
        ...
        <strong>Generated by:</strong> DocuMint AI (Qwen 2.5 Coder)
    </div>
