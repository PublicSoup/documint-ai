...
export type FileAction = "ai" | "delete" | "delete_project" | "rename" | "new_file" | "new_folder";
...
export type RuntimeKind = "node" | "static" | "python" | "rust" | "go" | "java" | "php" | "shell" | "docker" | "unknown";
