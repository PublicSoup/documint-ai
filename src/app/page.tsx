      ...
      <section className="pt-40 pb-20 px-6 relative">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <TrackedLink href="https://github.com/documintai" target="_blank" rel="noopener noreferrer" eventName="landing_secondary_cta_click" location="hero_secondary_github" variant={LANDING_EXPERIMENT_VARIANT}>
